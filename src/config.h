...
/* PIPELINE CONFIG */
    ...
    // Number of cl_mem objects used for processing info on brush strokes within the graphics pipeline (used for memory allocation and array iteration)
    #define NUM_STROKE_DATA_CLMEM 6
